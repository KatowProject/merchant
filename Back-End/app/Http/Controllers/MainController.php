...
class MainController extends Controller
{
    ...
    public function getDiscovery(Request $request)
    {
        ...
        $best_seller = $this->m_product->select('products.id', 'products.name', 'products.price', 'products.image', 'products.category_id', 'products.sub_category_id') // Add necessary columns
        ->join('order_product', 'products.id', '=', 'order_product.product_id')
            ->groupBy('products.id', 'products.name', 'products.price', 'products.category_id', 'products.image', 'products.sub_category_id') // Group by necessary columns
